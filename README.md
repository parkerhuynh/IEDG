...
Data Generator aims to create the data to train and evaluate the model. You can directly download the pre-generated data from [https://github.com/parkerhuynh/IEDG/tree/main/text-to-CDQL/data](here). 
